...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片在线管理配置区
        ,imageManagerUrl:"/api/imageManager.php"       //图片在线管理的处理地址
        ,imageManagerPath:'./upload/'                                    //图片修正地址，同imagePath
        ...
        ,toolbars:[["Undo","Redo","InsertImage","FontSize","Bold","Italic","Underline","StrikeThrough","ForeColor","BackColor","|","Superscript","Subscript","JustifyLeft","JustifyCenter","JustifyRight","LineHeight","|","InsertUnorderedList","InsertOrderedList","ClearDoc","SelectAll","Preview","|","Spechars","BlockQuote","FormatMatch","RemoveFormat","AutoTypeSet","PastePlain","|","SelectModule","Source","FullScreen"]]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{'undo':'','redo':'','insertimage':'','fontsize':'','bold':'','italic':'','underline':'','strikethrough':'','forecolor':'','backcolor':'','|':'','superscript':'','subscript':'','justifyleft':'','justifycenter':'','justifyright':'','lineheight':'','|':'','insertunorderedlist':'','insertorderedlist':'','cleardoc':'','selectall':'','preview':'','|':'','spechars':'','blockquote':'','formatmatch':'','removeformat':'','autotypeset':'','pasteplain':'','|':'','selectmodule':'','source':'','fullscreen':''}
